...
describe('atomic.katamari.api.str.ContainsTest', () => {
    it('unit test', () => {
        const check = (expected, str, substr) => {
    ...
    it('A string added to a string (at the end) must be contained within it', () => {
        fc.assert(fc.property(fc.string(), fc.string(1, 40), (str, contents) => {
    ...
    it('An empty string should contain nothing', () => {
        fc.assert(fc.property(fc.string(1, 40), (value) => !Strings.contains('', value)));
    });
    it('should handle the start and the end parameters', () => {
        const check = (expected, str, substr, start, end) => {
