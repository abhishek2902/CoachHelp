...
describe('atomic.katamari.api.obj.ObjFindTest', () => {
    ...
    it('the value found by find always passes predicate', () => {
        fc.assert(fc.property(fc.dictionary(fc.asciiString(), fc.json()), fc.func(fc.boolean()), (obj, pred) => {
    ...
    it('If object is empty, find is always none', () => {
        fc.assert(fc.property(fc.func(fc.boolean()), (pred) => {
...
//# sourceMappingURL=ObjFindTest.js.map