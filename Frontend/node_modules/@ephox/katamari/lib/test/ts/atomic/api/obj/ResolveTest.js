...
describe('atomic.katamari.api.obj.ResolveTest', () => {
    ...
    it('Checking that creating a namespace (forge) from an obj will enable that value to be retrieved by resolving (path)', () => {
        ...
        fc.dictionary(fc.asciiString(), fc.dictionary(fc.asciiString(), fc.constant({})))), fc.array(fc.asciiString(1, 30), 1, 40), fc.asciiString(1, 30), fc.asciiString(1, 30), (dict, parts, field, newValue) => {
...
//# sourceMappingURL=ResolveTest.js.map