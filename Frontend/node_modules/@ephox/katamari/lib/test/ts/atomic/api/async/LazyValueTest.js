...
describe('atomic.katamari.api.async.LazyValueTest', () => {
    it('get', () => new Promise((resolve, reject) => {
    ...
    it('map', () => new Promise((resolve, reject) => {
        const f = (x) => x + 'hello';
    ...
    it('isReady', () => new Promise((resolve, reject) => {
        const lazy = LazyValue.nu((callback) => {
            setTimeout(() => {
                callback('extra');
            }, 50);
    ...
    it('pure', () => fc.assert(fc.asyncProperty(fc.integer(), (i) => new Promise((resolve, reject) => {
        LazyValue.pure(i).get((v) => {
            eqAsync('LazyValue.pure', i, v, reject);
            resolve();
        });
    }))));
    it('pure, map', () => fc.assert(fc.asyncProperty(fc.integer(), fc.func(fc.string()), (i, f) => new Promise((resolve, reject) => {
        LazyValue.pure(i).map(f).get((v) => {
            eqAsync('LazyValue.map', f(i), v, reject);
            resolve();
        });
    }))));
    it('delayed, map', () => fc.assert(fc.asyncProperty(fc.integer(), fc.func(fc.string()), (i, f) => new Promise((resolve, reject) => {
        LazyValue.nu((c) => {
            setTimeout(() => {
                c(i);
            }, 2);
    ...
    it('TINY-6106: LazyValue should only use the value from the first time the callback is called', () => new Promise((resolve, reject) => {
    ...
    it('TINY-6107: LazyValues.withTimeout never returns', () => new Promise((resolve, reject) => {
        LazyValues.withTimeout(Fun.noop, 1).get((actual) => {
            eqAsync('should time out', Optional.none(), actual, reject, tOptional());
            resolve();
        });
    }));
    it('TINY-6107: LazyValues.withTimeout times out before it returns', () => new Promise((resolve, reject) => {
    ...
    it('TINY-6107: LazyValues.withTimeout times out after it returns', () => new Promise((resolve, reject) => {
        LazyValues.withTimeout((cb) => {
            setTimeout(() => {
                cb('cat');
            }, 10);
