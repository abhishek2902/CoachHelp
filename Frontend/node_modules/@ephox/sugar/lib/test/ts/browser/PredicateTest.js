...
describe('PredicateTest', () => {
    it('TBA: Structure check', () => {
        ...
        Checkers.checkOpt(Optional.none(), PredicateFind.sibling(TestPage.t5, SugarNode.isText));
        Checkers.checkOpt(Optional.some(TestPage.s3), PredicateFind.sibling(TestPage.s4, Checkers.isName('span')));
        Checkers.checkOpt(Optional.none(), PredicateFind.ancestor(TestPage.t4, Checkers.isName('li')));
        Checkers.checkOpt(Optional.some(TestPage.container), PredicateFind.ancestor(TestPage.s4, Checkers.isName('div')));
        Checkers.checkOpt(Optional.none(), PredicateFind.ancestor(TestPage.s2, Checkers.isName('span')));
        ...
        Checkers.checkOpt(Optional.none(), PredicateFind.child(TestPage.p2, SugarNode.isText));
