...
declare const ancestor: (scope: SugarElement<Node>, predicate: (e: SugarElement<Node>) => boolean, isRoot?: ((e: SugarElement<Node>) => boolean) | undefined) => boolean;
declare const closest: (scope: SugarElement<Node>, predicate: (e: SugarElement<Node>) => boolean, isRoot?: ((e: SugarElement<Node>) => boolean) | undefined) => boolean;
