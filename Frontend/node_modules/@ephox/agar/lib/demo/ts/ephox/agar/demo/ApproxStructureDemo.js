...
export const demo = () => {
    DemoContainer.init('Approx Structure', (success, failure) => {
        ...
        Class.add(span, 'dog');
        Pipeline.async({}, [
            Assertions.sAssertStructure('Assert Structure example: ' + Html.getOuter(div), ApproxStructure.build((s, str, arr) => s.element('div', {
                children: [
                    s.element('p', {
                        children: [
                            s.element('span', {
...
//# sourceMappingURL=ApproxStructureDemo.js.map