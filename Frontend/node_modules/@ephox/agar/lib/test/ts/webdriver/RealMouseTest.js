...
import { Attribute, Class, Css, DomEvent, Html, Insert, Remove, SugarBody, SugarElement } from '@ephox/sugar';
...
describe('RealMouseTest promise based variant', () => {
    ...
    after(() => {
        binder === null || binder === void 0 ? void 0 : binder.unbind();
        if (container) {
            Remove.remove(container);
        }
    });
