...
describe('atomic.agar.datatransfer.DataTransferItemTest', () => {
    it('Create transfer item from file', () => {
        ...
        Assert.eq('Should be expected file', 'a.txt', (_a = fileItem.getAsFile()) === null || _a === void 0 ? void 0 : _a.name);
        Assert.eq('Should be expected file', 'text/plain', (_b = fileItem.getAsFile()) === null || _b === void 0 ? void 0 : _b.type);
...
//# sourceMappingURL=DataTransferItemTest.js.map