...
describe('eqAny', function () {
    it('eqs', function () {
        fc.assert(fc.property(fc.anything(), function (x) { return (typeof x === 'number' && isNaN(x)) || eqAny.eq(x, x); }));
        fc.assert(fc.property(fc.anything(), function (x) { return (typeof x === 'number' && isNaN(x)) || !eqAny.eq(x, { z: x }); }));
