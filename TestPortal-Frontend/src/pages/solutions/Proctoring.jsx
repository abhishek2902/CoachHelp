...
export default function Proctoring() {
  const features = [
    {
      ...
      description: "Detect suspicious behavior, face absence, and multiple people with advanced AI algorithms.",
      color: "from-red-500 to-red-600"
    },
    {
      icon: <Eye className="w-8 h-8 text-white" />,
      title: "Live & Recorded Monitoring",
      description: "Monitor exams in real-time or review recorded sessions for complete flexibility.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: <Clock className="w-8 h-8 text-white" />,
      title: "Real-Time Alerts",
      description: "Get instant notifications for suspicious activities, allowing immediate intervention.",
      color: "from-yellow-500 to-yellow-600"
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-white" />,
      title: "Detailed Proctoring Reports",
      description: "Comprehensive logs and analytics for every exam session, including flagged events and timestamps.",
      color: "from-purple-500 to-purple-600"
    },
    {
      icon: <Globe className="w-8 h-8 text-white" />,
      title: "Global Accessibility",
      description: "Proctor exams for candidates anywhere in the world, on any device.",
      color: "from-indigo-500 to-indigo-600"
    },
    {
      icon: <Zap className="w-8 h-8 text-white" />,
      title: "Seamless Integration",
      description: "Integrate proctoring with your LMS, exam platform, or use standalone. Easy setup and deployment.",
      color: "from-green-500 to-green-600"
    }
  ];

  const benefits = [
    "Ensure exam integrity and prevent cheating",
    "Reduce manual proctoring workload by 80%",
    "Comprehensive evidence for dispute resolution",
    "Build trust with students and stakeholders",
    "Comply with accreditation and regulatory standards",
    "Flexible for both live and automated proctoring"
  ];
  ...
  const testimonials = [
    {
      ...
      content: "Talenttest.io's proctoring solution is the best we've used. The AI detection and reporting are incredibly thorough.",
      rating: 5
    },
    {
      name: "John Miller",
      role: "Assessment Manager",
      institution: "Global Certification Board",
      content: "We proctored thousands of exams remotely with zero incidents. The live monitoring and alerts are invaluable.",
      rating: 5
    }
  ];
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      <Helmet>
        <title>Proctoring | Talenttest.io</title>
        <meta name="description" content="Ensure exam integrity with AI-powered proctoring from Talenttest.io. Live and automated monitoring, real-time alerts, and detailed reports." />
        <meta property="og:title" content="Proctoring | Talenttest.io" />
        <meta property="og:description" content="Ensure exam integrity with AI-powered proctoring from Talenttest.io. Live and automated monitoring, real-time alerts, and detailed reports." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://talenttest.io/solutions/proctoring" />
      </Helmet>
      ...
      <section className="relative bg-gray-900 text-white overflow-hidden pt-20">
        <div className="absolute inset-0 bg-gradient-to-br from-red-800 via-blue-800 to-gray-900 opacity-90"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight">
                Proctoring
                <span className="block text-red-300">AI-Powered Exam Integrity</span>
              </h1>
              <p className="mb-8 text-lg md:text-xl text-gray-300 max-w-xl mx-auto lg:mx-0">
                Ensure exam integrity with advanced AI-powered proctoring, live monitoring, and detailed reporting.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link 
                  to="/pricing" 
                  className="group inline-flex items-center justify-center bg-red-600 text-white px-8 py-3 rounded-lg font-bold text-lg shadow-lg hover:bg-red-700 transition-transform transform hover:scale-105"
                >
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-2 mt-8 text-sm text-gray-400">
                ...
                <span className="flex items-center gap-2"><Star className="w-4 h-4 text-yellow-300" /> 4.9/5 Proctoring Rating</span>
                <span className="flex items-center gap-2"><Globe className="w-4 h-4 text-red-300" /> 50+ Countries</span>
              </div>
            </div>
            {/* Floating Product Image */}
            <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
              <div className="absolute w-full h-full bg-red-500 rounded-full -bottom-24 -right-12 blur-3xl opacity-20"></div>
              <RotatableYouTubeVideo videoId="TX5FmtmWPtc" title="Proctoring Demo" />
            </div>
          </div>
        </div>
      </section>
      ...
      <main className="flex-1 w-full">
        ...
        <section id="features" className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Everything You Need for Secure Proctoring</h2>
              <p className="text-lg text-gray-600">
                Our platform provides advanced proctoring tools for live and automated exam monitoring.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Why Choose Talenttest.io for Proctoring?</h2>
                <p className="text-lg text-gray-600 mb-8">
                  Join leading institutions who trust Talenttest.io for secure, scalable, and reliable proctoring.
                </p>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Reduced Cheating</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-600 mb-1">90%</div>
                    <div className="text-sm text-gray-600">Faster Dispute Resolution</div>
                  </div>
                  <div className="text-center">
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600">
                Hear from institutions who have ensured exam integrity with Talenttest.io.
              </p>
            </div>
        ...
        <section className="bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center bg-gradient-to-r from-red-600 to-blue-600 rounded-t-2xl">
            <h2 className="text-3xl md:text-4xl font-extrabold text-white">Ready for Secure Proctoring?</h2>
            <p className="text-red-200 mt-4 mb-8 text-lg">Join leading institutions who are already using Talenttest.io for secure, scalable proctoring.</p>
