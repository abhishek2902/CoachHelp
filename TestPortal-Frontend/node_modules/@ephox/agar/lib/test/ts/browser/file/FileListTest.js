...
UnitTest.test('FileListTest', () => {
    ...
    Assert.eq('Should be expected file by item index', 'a.txt', (_a = files.item(0)) === null || _a === void 0 ? void 0 : _a.name);
    Assert.eq('Should be expected file by index', 'b.html', files[1].name);
    Assert.eq('Should be expected file by item index', 'b.html', (_b = files.item(1)) === null || _b === void 0 ? void 0 : _b.name);
    Assert.eq('Should not be an array', false, Type.isArray(files));
});
//# sourceMappingURL=FileListTest.js.map