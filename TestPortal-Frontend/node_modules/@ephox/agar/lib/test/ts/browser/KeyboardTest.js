...
UnitTest.asynctest('KeyboardTest', (success, failure) => {
    ...
    const listenOn = (type, f, code, modifiers) => Step.control(Step.raw((value, next, die, logs) => {
    ...
    const listenOnKeystroke = (code, modifiers) => Step.control(Step.raw((value, next, die, initLogs) => {
