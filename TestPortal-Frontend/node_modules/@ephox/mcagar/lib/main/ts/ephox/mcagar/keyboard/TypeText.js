...
const isText = (node) => SugarNode.isText(SugarElement.fromDom(node));
const insertCharAtRange = (rng, chr, doc) => {
...
const typeContentAtSelection = (doc, text) => {
    Arr.map(text.split(''), Fun.curry(typeChar, doc));
};
export { typeContentAtSelection };
