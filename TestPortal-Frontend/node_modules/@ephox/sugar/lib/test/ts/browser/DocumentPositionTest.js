...
UnitTest.test('DocumentPositionTest', () => {
    ...
    const check = (expected, start, soffset, finish, foffset, msg) => {
    ...
    (() => {
        ...
        /* div+-p1
              ...
              +-p2
                 +-p2br
        */
        Assert.eq('lca(div,0,div,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(div, 0, div, 0)) + `, expected: '<div>...'`, true, Compare.eq(div, DocumentPosition.commonAncestorContainer(div, 0, div, 0)));
        Assert.eq('lca(p1,0,p2,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p11, 0, p2, 0)) + `, expected: '<div>...'`, true, Compare.eq(div, DocumentPosition.commonAncestorContainer(p11, 0, p2, 0)));
        Assert.eq('lca(div,1,div,2)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(div, 1, div, 2)) + `, expected: '<div>...'`, true, Compare.eq(div, DocumentPosition.commonAncestorContainer(div, 1, div, 2)));
        Assert.eq('lca(p1span1,0,p2br,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p1span1, 0, p2br, 0)) + `, expected: '<div>...'`, true, Compare.eq(div, DocumentPosition.commonAncestorContainer(p1span1, 0, p2br, 0)));
        Assert.eq('lca(p1text,0,p1span2,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p1text, 0, p1span2, 0)) + `, expected: 'p1': <p>One, two...`, true, Compare.eq(p11, DocumentPosition.commonAncestorContainer(p1text, 0, p1span2, 0)));
        Assert.eq('lca(p1span1,0,p1span2,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p1span1, 0, p1span2, 0)) + `, expected: 'p1span': <span>cat dog </span>`, true, Compare.eq(p1span, DocumentPosition.commonAncestorContainer(p1span1, 0, p1span2, 0)));
    })();
});
