...
UnitTest.test('Browser Test: SelectionRectanglesTest', () => {
    ...
    const rect1 = WindowSelection.getFirstRect(window, selP1).getOrDie('There should be a rectangle for paragraph 1');
    const rect2 = WindowSelection.getFirstRect(window, selP2).getOrDie('There should be a rectangle for paragraph 2');
    Assert.eq('Rect 1 should be above Rect 2. (1) was ' + rect1.top + ', and (2) was ' + rect2.top, true, rect1.top < rect2.top);
    const bounds1 = WindowSelection.getBounds(window, selP1).getOrDie('There should be bounds for paragraph 1');
    const bounds2 = WindowSelection.getBounds(window, selP2).getOrDie('There should be bounds for paragraph 2');
