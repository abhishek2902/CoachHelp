...
UnitTest.test('DimensionTest', () => {
    ...
    const runChecks = (dimension, borderBox) => {
    ...
    */
    ...
    const tbl = SugarElement.fromHtml('<table><caption style="height: 300px"></caption><tbody><tr><td style="height: 10px"></td></tr></tbody></table>');
    Insert.append(bounds, tbl);
    Assert.eq('Height should be more than 300', true, Height.getOuter(tbl) > 300);
    // Height on detached node
    const detachedElm = SugarElement.fromHtml('<div>a</div>');
