...
export const withNormalElement = (f) => {
    const div = SugarElement.fromTag('div');
    Insert.append(SugarBody.body(), div);
    f(div);
    Remove.remove(div);
};
export const setupShadowRoot = (mode) => {
...
export const withShadowElementInMode = (mode, f) => {
