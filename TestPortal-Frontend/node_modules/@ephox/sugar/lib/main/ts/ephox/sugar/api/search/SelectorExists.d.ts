...
declare const ancestor: (scope: SugarElement<Node>, selector: string, isRoot?: ((e: SugarElement<Node>) => boolean) | undefined) => boolean;
...
declare const closest: (scope: SugarElement<Node>, selector: string, isRoot?: ((e: SugarElement<Node>) => boolean) | undefined) => boolean;
