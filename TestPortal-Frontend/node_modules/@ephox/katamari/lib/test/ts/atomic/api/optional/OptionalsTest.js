...
describe('atomic.katamari.api.optional.OptionalsTest', () => {
    ...
    it('Optionals.cat of somes and nones should have length <= original', () => {
        fc.assert(fc.property(fc.array(ArbDataTypes.arbOptional(fc.integer())), (arr) => {
    ...
    it('Optionals.cat of nones.concat(somes).concat(nones) should be somes', () => {
        fc.assert(fc.property(fc.array(fc.json()), fc.array(fc.json()), fc.array(fc.json()), (before, on, after) => {
...
//# sourceMappingURL=OptionalsTest.js.map