...
describe('atomic.katamari.api.arr.ArrEachTest', () => {
    context('Arr.each', () => {
        it('unit test', () => {
            const checkLHelper = (expected, input) => {
                const values = [];
                Arr.each(input, (x, i) => {
    ...
    context('Arr.eachr', () => {
        it('unit test', () => {
            const checkRHelper = (expected, input) => {
                const values = [];
                Arr.eachr(input, (x, i) => {
                    values.push({ index: i, value: x });
                });
