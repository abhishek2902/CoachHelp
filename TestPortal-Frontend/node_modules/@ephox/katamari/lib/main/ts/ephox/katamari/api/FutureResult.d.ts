...
export declare const FutureResult: {
    ...
    pure: <A_2, E_2 = any>(value: A_2) => FutureResult<A_2, E_2>;
    value: <A_2, E_2 = any>(value: A_2) => FutureResult<A_2, E_2>;
    error: <A_3 = any, E_3 = any>(error: E_3) => FutureResult<A_3, E_3>;
    fromResult: <A_4, E_4>(result: Result<A_4, E_4>) => FutureResult<A_4, E_4>;
    fromFuture: <A_5>(future: Future<A_5>) => FutureResult<A_5, never>;
    fromPromise: <T, E_5 = any>(promise: Promise<T>) => FutureResult<T, E_5>;
};
