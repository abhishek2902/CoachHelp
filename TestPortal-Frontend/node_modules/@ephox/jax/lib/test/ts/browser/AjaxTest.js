...
const expectError = (label, response) => FutureResult.nu((callback) => {
    response.get((res) => {
        res.fold((_err) => {
...
const expectValue = (label, value, response) => FutureResult.nu((callback) => {
    response.get((res) => {
        res.fold((err) => {
...
const expectBlobJson = (label, value, response) => FutureResult.nu((callback) => {
    response.get((res) => {
        res.fold((err) => {
            callback(Result.error(new Error(err.message)));
        }, (blob) => {
